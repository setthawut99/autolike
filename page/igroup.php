...
<head>
    ...
    <body>
                    ...
                    <div class="span9">
                        <div class="content">
							...
							<div class="module-head">
								<h3 style="text-align:center;font-family: 'Kanit', sans-serif;">ดึงเพื่อนเข้ากลุ่ม</h3>
							</div>
							<div class="module-body">
								<div id="alerts"></div>
								<div class="input-prepend">
									<span class="add-on" style="font-family: 'Kanit', sans-serif;">ไอดีกลุ่ม</span><input class="span8" type="text" id="text_group" placeholder="GROUP ID">       
								</div>
								<a class="btn btn-large btn-danger btn-block" style="font-family: 'Kanit', sans-serif;" id="onclick_igroup" onclick="igroup();" data-loading-text="<i class='fa fa-refresh fa-spin' aria-hidden='true'></i> โปรดรอสักครู่ระบบกำลังทำรายการ . . ."><i class="fa fa-star" aria-hidden="true"></i> ขอเข้ากลุ่ม</a>
								<a class="btn btn-large btn-danger btn-block" style="font-family: 'Kanit', sans-serif;" id="onclick_dgroup" onclick="dgroup();" data-loading-text="<i class='fa fa-refresh fa-spin' aria-hidden='true'></i> โปรดรอสักครู่ระบบกำลังทำรายการ . . ."><i class="fa fa-star" aria-hidden="true"></i> ดึงคนเข้ากลุ่ม</a>
							</div>
						</div>
                        </div>
                    </div>
        ...
        <div class="footer">
            <div class="container">
                COPYRIGHT © 2018 ALL SYSTEM BY <a href="//www.facebook.com/1084581158369280">ผู้พัน Studio</a>
            </div>
        </div>
